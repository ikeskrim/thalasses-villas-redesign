...
Run 2026-09-14T17:43:44.912Z with `node scripts/encoding-table.mjs`. Paths are sent exactly as written.
...
| `/en/contact` | first letter, %XX | `/en/%63ontact` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/contact` | hex letter, lower-case escape | `/en/c%6fntact` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/contact` | hex letter, upper-case escape | `/en/c%6Fntact` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/contact` | locale segment encoded | `/%65n/contact` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/contact` | %2F between segments | `/en%2Fcontact` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/contact` | encoded trailing slash | `/en/contact%2F` | 308 | `–` | text/plain | 1 | 15 | fra1 |
...
| `/en/contact` | first letter encoded + .rsc | `/en/%63ontact.rsc` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/contact` | first letter encoded, RSC header (RSC: 1) | `/en/%63ontact` | 308 | `–` | text/plain | 1 | 15 | fra1 |
| `/en/the-estate` | plain | `/en/the-estate` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
| `/en/the-estate` | first letter, %XX | `/en/%74he-estate` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
| `/en/the-estate` | hex letter, lower-case escape | `/en/the%2destate` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
| `/en/the-estate` | hex letter, upper-case escape | `/en/the%2Destate` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
| `/en/the-estate` | locale segment encoded | `/%65n/the-estate` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
| `/en/the-estate` | %2F between segments | `/en%2Fthe-estate` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
| `/en/the-estate` | encoded trailing slash | `/en/the-estate%2F` | 200 | `/en/the-estate` | text/html | 1 | 187927 | fra1 |
...
| `/en/the-estate` | first letter encoded + .rsc | `/en/%74he-estate.rsc` | 200 | `/en/the-estate.rsc` | text/x-component | 1 | 60207 | fra1 |
| `/en/the-estate` | first letter encoded, RSC header (RSC: 1) | `/en/%74he-estate` | 200 | `/en/the-estate.rsc` | text/x-component | 1 | 60207 | fra1 |
