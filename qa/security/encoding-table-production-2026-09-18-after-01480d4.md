...
Run 2026-09-18T08:49:17.590Z with `node scripts/encoding-table.mjs`. Paths are sent exactly as written.
...
| `/en/contact` | first letter encoded, segment prefetch path | `/en/%63ontact.segments/_tree.segment.rsc` | 301 | `/en/contact` | `–` | text/plain | 1 | 15 | fra1 |
...
| `/en/the-estate` | first letter encoded, segment prefetch path | `/en/%74he-estate.segments/_tree.segment.rsc` | 301 | `/en/the-estate` | `–` | text/plain | 1 | 15 | fra1 |
...
| `/en/villas/villa-thoi` | first letter encoded, segment prefetch path | `/en/villas/%76illa-thoi.segments/_tree.segment.rsc` | 301 | `/en/villas/villa-thoi` | `–` | text/plain | 1 | 15 | fra1 |
...
| `/en/experiences/boat-trip` | first letter encoded, segment prefetch path | `/en/experiences/%62oat-trip.segments/_tree.segment.rsc` | 301 | `/en/experiences/boat-trip` | `–` | text/plain | 1 | 15 | fra1 |
