...
**40 text runs measured. 0 below AA.**
...
|---|---|---|---|---|---|---|
| type-alive | desktop | `te-kicker` | 12px | **4.93:1** | 4.5:1 | pass |
| type-alive | phone | `te-kicker` | 12px | **4.98:1** | 4.5:1 | pass |
...
| type-alive | desktop | `te-display` | 96px | **14.68:1** | 3:1 | pass |
| type-alive | phone | `te-display` | 46px | **14.71:1** | 3:1 | pass |
| golden | desktop | `lk-lede` | 19px | **14.86:1** | 4.5:1 | pass |
| type-alive | phone | `te-lede` | 20px | **15.57:1** | 4.5:1 | pass |
...
| type-alive | desktop | `te-lede` | 28px | **16.03:1** | 3:1 | pass |
